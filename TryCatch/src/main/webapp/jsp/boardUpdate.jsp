...
<body>
	...
	<div class="webcontaner">
		<div class="wrap">
			<div class="writerBox">
				김철수님 TryCatch 에서 즐거운 커뮤니티 활동이 되길 try 합니다.
			</div>
			...
			<div class="buttonBox">
				<button onclick="onUpdate()" class="writeBtn" type="button">글 수정하기</button>
			</div>
		</div>
	</div>
...
<script src="/TryCatch/js/board/boardUpdate.js" type="text/javascript"></script>
</body>
</html>